...
<tr><td> <em>Generated: </em> 2/9/2022 12:16:55 PM</td></tr>
<tr><td> <em>Grading Link: </em> <a rel="noreferrer noopener" href="https://learn.ethereallab.app/homework/IT202-006-S22/m2-php-hw/grade/pn253" target="_blank">Grading</a></td></tr></table>
...
<tr><td><table><tr><td><img width="768px" src="https://user-images.githubusercontent.com/61835121/153251744-ac784c39-e128-4203-9a88-4403c9332b1c.png"/></td></tr>
<tr><td> <em>Caption:</em> <p>shows that is deployed on Heroku and shows the proper output. <br></p>
</td></tr>
</table></td></tr>
<tr><td> <em>Sub-Task 2: </em> Describe how you solved the problem</td></tr>
<tr><td> <em>Response:</em> <p>Used a simple foreach loop to iterate through the array and used modulus<br>to check if value was odd. Using % 2, if the value was<br>odd would return a 1, so when it did I echoed out the<br>value along with a newline character to put space between values. <br></p><br></td></tr>
</table></td></tr>
...
<tr><td><table><tr><td><img width="768px" src="https://user-images.githubusercontent.com/61835121/153252356-340c092e-9f30-4738-bb13-ed6c4c94723a.png"/></td></tr>
<tr><td> <em>Caption:</em> <p>Showing the Heroku url and deployment along with the values from the output.<br><br></p>
</td></tr>
</table></td></tr>
<tr><td> <em>Sub-Task 2: </em> Describe how you solved the problem</td></tr>
<tr><td> <em>Response:</em> <p>I used a foreach loop to add all the values to $total with<br>the += operator. Then I rounded the value to 2 decimal places using<br>round() and made sure the format was correct by using number_format(). This function<br>added the tailing zeros where needed. <br></p><br></td></tr>
</table></td></tr>
...
<tr><td><table><tr><td><img width="768px" src="https://user-images.githubusercontent.com/61835121/153252812-c1027b42-b001-457c-ad9b-38767c06b5be.png"/></td></tr>
<tr><td> <em>Caption:</em> <p>Showing the Heroku url and deployment along with the values from the output.<br><br></p>
</td></tr>
</table></td></tr>
<tr><td> <em>Sub-Task 2: </em> Describe how you solved the problem</td></tr>
<tr><td> <em>Response:</em> <p>I iterated through the array using a foreach loop and used the abs()<br>function to take the absolute value of the values from array. Also added<br>a end of line character to add spaces between the values. <br></p><br></td></tr>
</table></td></tr>
...
<tr><td> <a rel="noreferrer noopener" target="_blank" href="https://pn253-prod.herokuapp.com/M2/problem1.php">https://pn253-prod.herokuapp.com/M2/problem1.php</a> </td></tr>
...
<tr><td> <a rel="noreferrer noopener" target="_blank" href="https://pn253-prod.herokuapp.com/M2/problem2.php">https://pn253-prod.herokuapp.com/M2/problem2.php</a> </td></tr>
...
<tr><td> <a rel="noreferrer noopener" target="_blank" href="https://pn253-prod.herokuapp.com/M2/problem3.php">https://pn253-prod.herokuapp.com/M2/problem3.php</a> </td></tr>
<tr><td> <em>Sub-Task 4: </em> Pull Request URL for M2-PHP-HW to dev</td></tr>
<tr><td> <a rel="noreferrer noopener" target="_blank" href="https://github.com/Term4K/IT202-006/pull/4">https://github.com/Term4K/IT202-006/pull/4</a> </td></tr>
<tr><td> <em>Sub-Task 5: </em> Talk about what you learned, any issues you had, how you resolve them</td></tr>
<tr><td> <em>Response:</em> <p>Many of this was review from what I did in CS288 but I<br>had to look up the related functions in the php documentation. Also the<br>values displayed in the second problem are always in single quotes and I<br>have figured out that this is due to the variable $total being and<br>string and how var_export() displays the value. I could not use a float<br>as it did not have the trailing zeros as required by the sub-task.<br>A solution to this is to just concatenate directly to the $total variable<br>instead of using the var_export(). I have included commented code of this solution<br>in the problem2.php file. <br></p><br></td></tr>
</table></td></tr>
<table><tr><td><em>Grading Link: </em><a rel="noreferrer noopener" href="https://learn.ethereallab.app/homework/IT202-006-S22/m2-php-hw/grade/pn253" target="_blank">Grading</a></td></tr></table>