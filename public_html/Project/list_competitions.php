...
LEFT JOIN (SELECT * FROM UserComps WHERE user_id = :uid) as uc ON uc.comp_id = Comps.id WHERE expires > current_timestamp() AND paid_out < 1 AND did_calc < 1 ORDER BY expires asc LIMIT 10");
$results = [];
try {
